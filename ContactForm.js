    ...
    validateForm(element = null) {
        ...
        elements.forEach(element => {
            ...
            if (element.checkValidity() == false) {
                ...
                if (!element.querySelector(".validation-error")) {
                    element.insertAdjacentHTML("afterend", `<p class="validation-error">${element.title}</p>`);
                }
                ...
                if (element.querySelector(".validation-error")) {
                    element.querySelector(".validation-error").remove();
                }
