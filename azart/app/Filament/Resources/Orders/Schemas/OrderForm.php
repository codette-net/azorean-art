                        ...
                        Step::make('Order Details')
                            ->schema([
                                ...
                                Select::make('payment_status')
                                    ->options(['pending' => OrderPaymentStatusEnum::PENDING->value,
                                        'paid' => OrderPaymentStatusEnum::PAID->value,
                                        'failed' => OrderPaymentStatusEnum::FAILED->value
                                    ])
                                    ->default('pending')
                                    ->required(),
